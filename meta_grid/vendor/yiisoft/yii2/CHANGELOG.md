...
- Bug #6991: Fixed exception when using `{use class='yii\bootstrap4\Nav' type='function'}` (ivanlemeshev)
...
- Bug #3443: Fixed `yii\bootstrap4\Nav` and `yii\bootstrap4\Dropdown` were generating wrong ids for submenus (arturf)

...
namespace vendor\meta_grid\gii_template\crud;
...
// Following methods must stay in the class
     ...
     * - If model class has a function named "getName", it will also return "name".
     * 
     * @return string
     */
    public function getNameAttribute()
    {
        ...
        // if attributes been added:
        // if (in_array("name", (new $this->modelClass)->attributes()))
        // {
        //     return "name";
        // }

        if (in_array("getName",get_class_methods($class)))
        {
            return "name";
        }

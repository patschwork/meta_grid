...
class CodemirrorAsset extends \yii\web\AssetBundle
{
	...
	/// /// 
	const ADDON_AUTOSUGGEST = 'ADDON_AUTOSUGGEST';
	const ADDON_AUTOSUGGEST_MODIFIED = 'ADDON_AUTOSUGGEST_MODIFIED';
	/// /// 	
	...
	private static $_js=[
		...
		/// //// 
		self::ADDON_AUTOSUGGEST => 'addon/_external_autosuggest/autosuggest.js',
		self::ADDON_AUTOSUGGEST_MODIFIED => 'addon/_external_autosuggest/autosuggest_modified.js',
		/// //// 

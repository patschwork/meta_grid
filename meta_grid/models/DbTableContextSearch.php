...
/**
 * DbTableContextSearch represents the model behind the search form about `VDbTableContextSearchinterface`.
 */
class DbTableContextSearch extends VDbTableContextSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VDbTableContextSearchinterface::find();        

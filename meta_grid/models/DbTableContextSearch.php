...
/**
 * DbTableContextSearch represents the model behind the search form about `app\models\DbTableContext`.
 */
class DbTableContextSearch extends DbTableContext
{
    /**
     * @inheritdoc
     */

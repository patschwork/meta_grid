...
/**
 * BracketSearch represents the model behind the search form about `VBracketSearchinterface`.
 */
class BracketSearch extends VBracketSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VBracketSearchinterface::find();        

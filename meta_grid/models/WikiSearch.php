...
/**
 * WikiSearch represents the model behind the search form about `VWikiSearchinterface`.
 */
class WikiSearch extends VWikiSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VWikiSearchinterface::find();        

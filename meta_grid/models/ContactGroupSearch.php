...
use app\models\VContactGroupSearchinterface;

/**
 * ContactGroupSearch represents the model behind the search form about `VContactGroupSearchinterface`.
 */
class ContactGroupSearch extends VContactGroupSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'fk_object_type_id', 'fk_client_id', 'fk_deleted_status_id', 'fk_object_persistence_method_id', 'fk_datamanagement_process_id'], 'integer'],
            [['uuid', 'name', 'description', 'short_name'], 'safe'],
        ];
    }
    ...
    {
        $query = VContactGroupSearchinterface::find();        

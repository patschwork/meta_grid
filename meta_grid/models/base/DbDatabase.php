...
/**
 * This is the base-model class for table "db_database".
 *
 * @property integer $id
 ...
 */
class DbDatabase extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['uuid', 'name', 'description', 'source_definition', 'source_comment'], 'string'],

...
/**
 * GlossarySearch represents the model behind the search form about `VGlossarySearchinterface`.
 */
class GlossarySearch extends VGlossarySearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VGlossarySearchinterface::find();        

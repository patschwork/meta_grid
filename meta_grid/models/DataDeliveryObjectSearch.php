...
/**
 * DataDeliveryObjectSearch represents the model behind the search form about `app\models\DataDeliveryObject`.
 */
class DataDeliveryObjectSearch extends DataDeliveryObject
{
    /**
     * @inheritdoc
     */

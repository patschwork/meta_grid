...
/**
 * DataDeliveryObjectSearch represents the model behind the search form about `VDataDeliveryObjectSearchinterface`.
 */
class DataDeliveryObjectSearch extends VDataDeliveryObjectSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VDataDeliveryObjectSearchinterface::find();        

...
use app\models\VClientSearchinterface;

/**
 * ClientSearch represents the model behind the search form about `VClientSearchinterface`.
 */
class ClientSearch extends VClientSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VClientSearchinterface::find();        

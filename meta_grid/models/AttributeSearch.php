...
/**
 * AttributeSearch represents the model behind the search form about `VAttributeSearchinterface`.
 */
class AttributeSearch extends VAttributeSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VAttributeSearchinterface::find();        

...
use app\models\VDbTableTypeSearchinterface;

/**
 * DbTableTypeSearch represents the model behind the search form about `VDbTableTypeSearchinterface`.
 */
class DbTableTypeSearch extends VDbTableTypeSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VDbTableTypeSearchinterface::find();        

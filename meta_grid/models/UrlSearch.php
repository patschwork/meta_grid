...
/**
 * UrlSearch represents the model behind the search form about `VUrlSearchinterface`.
 */
class UrlSearch extends VUrlSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VUrlSearchinterface::find();        

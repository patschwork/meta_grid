...
/**
 * DbDatabaseSearch represents the model behind the search form about `VDbDatabaseSearchinterface`.
 */
class DbDatabaseSearch extends VDbDatabaseSearchinterface 
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['uuid', 'name', 'description', 'source_definition', 'source_definition_language', 'source_comment'], 'safe'],
    ...
    {
        $query = VDbDatabaseSearchinterface::find();        

...
/**
 * DbDatabaseSearch represents the model behind the search form about `app\models\DbDatabase`.
 */
class DbDatabaseSearch extends DbDatabase
{
    /**
     * @inheritdoc
     */

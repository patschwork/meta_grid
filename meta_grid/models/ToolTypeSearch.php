...
use app\models\VToolTypeSearchinterface;

/**
 * ToolTypeSearch represents the model behind the search form about `VToolTypeSearchinterface`.
 */
class ToolTypeSearch extends VToolTypeSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VToolTypeSearchinterface::find();        

...
/**
 * SchedulingSearch represents the model behind the search form about `VSchedulingSearchinterface`.
 */
class SchedulingSearch extends VSchedulingSearchinterface 
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = VSchedulingSearchinterface::find();        

...
use yii\helpers\Url;
use app\models\VGlossarySearchinterface;
/* @var $this yii\web\View */
/* @var $searchModel app\models\GlossarySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Glossaries');
...
?>
    ...
    <p>
		<?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-glossary')  ? Html::a(
		Yii::t('app', 'Create {modelClass}', ['modelClass' => Yii::t('app', 'Glossary'),]), ['create'], ['class' => 'btn btn-success']) : "" ?>
					</p>
	...
	?>
	    <?= GridView::widget([
		'tableOptions' => ['id' => 'grid-view-glossary', 'class' => 'table table-striped table-bordered'],
        ...
        'columns' => [
            ...
            [
             ...
             'value' => function($model) {
             		...
             		'filter' => Select2::widget([
             				...
             				'data' => ArrayHelper::map(VGlossarySearchinterface::find()->select(['fk_client_id', 'client_name'])->distinct()->asArray()->all(), 'fk_client_id', 'client_name'),
            ...
            'filter' => Select2::widget([
            		...
            		'data' => ArrayHelper::map(VGlossarySearchinterface::find()->select(['fk_project_id', 'project_name'])->distinct()->asArray()->all(), 'fk_project_id', 'project_name'),

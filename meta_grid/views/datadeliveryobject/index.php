...
/*            [
             ...
             'value' => function($model) {
             		return $model->fk_contact_group_id_as_data_owner == "" ? $model->fk_contact_group_id_as_data_owner : (isset($_GET["searchShow"]) ? $model->fkContactGroupIdAsDataOwner->name . ' [' . $model->fk_contact_group_id_as_data_owner . ']' : $model->fkContactGroupIdAsDataOwner->name);
             		},
            'filter' => Select2::widget([
            		'model' => $searchModel,

...
use yii\helpers\Url;
use app\models\VUrlSearchinterface;
...
?>
    ...
    <p>
		<?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-url')  ? Html::a(
		Yii::t('app', 'Create {modelClass}', ['modelClass' => Yii::t('app', 'Url'),]), ['create'], ['class' => 'btn btn-success']) : "" ?>
					</p>
	...
	?>
	    <?= GridView::widget([
		'tableOptions' => ['id' => 'grid-view-url', 'class' => 'table table-striped table-bordered'],
        ...
        'columns' => [
            ...
            [
             ...
             'value' => function($model) {
             		...
             		'filter' => Select2::widget([
             				...
             				'data' => ArrayHelper::map(VUrlSearchinterface::find()->select(['fk_client_id', 'client_name'])->distinct()->asArray()->all(), 'fk_client_id', 'client_name'),
            ...
            'filter' => Select2::widget([
            		...
            		'data' => ArrayHelper::map(VUrlSearchinterface::find()->select(['fk_project_id', 'project_name'])->distinct()->asArray()->all(), 'fk_project_id', 'project_name'),

...
<div class="contact-view">
    ...
    <p>
        <?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-contact')  ? Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) : "" ?>

        <?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('delete-contact')  ? Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id], [
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
             ...
             'value' =>         	    $model->fk_contact_group_id == "" ? $model->fk_contact_group_id : ($model->fkContactGroup === NULL ? Yii::t('app', "Can't lookup the {relFieldname} name (for id {this_id})", ['relFieldname' => 'fkContactGroup', 'this_id' => $model->fk_contact_group_id]) : $model->fkContactGroup->name)
            ],
            [

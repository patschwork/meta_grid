        ...
        'columns' => [
            ...
            [
             ...
             'value' => function($model) {
             		return $model->fk_contact_group_id == "" ? $model->fk_contact_group_id : (isset($_GET["searchShow"]) ? $model->fkContactGroup->name . ' [' . $model->fk_contact_group_id . ']' : $model->fkContactGroup->name);
             		},

...
/* @var $searchModel app\models\DbTableTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Db Table Types');
$this->params['breadcrumbs'][] = Yii::t('app', $this->title);
?>
<div class="db-table-type-index">
...
?>
    ...
    <p>
		<?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-dbtabletype')  ? Html::a(
		Yii::t('app', 'Create {modelClass}', ['modelClass' => Yii::t('app', 'Db Table Type'),]), ['create'], ['class' => 'btn btn-success']) : "" ?>
					</p>
	...
	?>
	    <?= GridView::widget([
		'tableOptions' => ['id' => 'grid-view-db-table-type', 'class' => 'table table-striped table-bordered'],
	...
	<?php 	if (\vendor\meta_grid\helper\Utils::get_app_config("floatthead_for_gridviews") == 1)
	{
		\bluezed\floatThead\FloatThead::widget(
			[
				'tableId' => 'grid-view-db-table-type', 
				'options' => [
					'top'=>'50'
				]
			]

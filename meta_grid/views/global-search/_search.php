...
<div class="vall-objects-union-search">
	...
	echo $form->field($model, 'object_type_name')->checkboxList(ArrayHelper::map(VAllObjectsUnion::find()->asArray()->all(), 'object_type_name', 'object_type_name'))->label("Filter object types");

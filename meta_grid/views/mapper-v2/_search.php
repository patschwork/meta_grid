...
<div class="vall-objects-union-search">
	...
	echo $form->field($model, 'object_type_name')->checkboxList(ArrayHelper::map(VAllObjectsUnion::find()->select(['object_type_name'])->distinct()->asArray()->all(), 'object_type_name', 'object_type_name'))->label("Filter object types");

...
?>
	...
	?>
        ...
        'columns' => [
            ...
            ,
				'template' => RBACHelper::filterActionColumn_meta_grid('{view} {update} {delete} {documentation}'),
				'buttons' => [
						'documentation' => function ($url, $model) {
							return Html::a('<span class="glyphicon glyphicon-list-alt"></span>', $url, [
									'title' => Yii::t('app', 'Documentation'),
							]);
						}
				],
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					if ($action === 'documentation') {
						$url = "?r=documentation/createdocumentation&project_id=" . $key; 
						return $url;
					}
				}
            ],

...
use app\models\VDbDatabaseSearchinterface;
/* @var $this yii\web\View */
/* @var $searchModel app\models\DbDatabaseSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Db Databases');
...
?>
    ...
    <p>
		<?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-dbdatabase')  ? Html::a(
		Yii::t('app', 'Create {modelClass}', ['modelClass' => Yii::t('app', 'Db Database'),]), ['create'], ['class' => 'btn btn-success']) : "" ?>
					</p>
	...
	?>
	    <?= GridView::widget([
		'tableOptions' => ['id' => 'grid-view-db-database', 'class' => 'table table-striped table-bordered'],
        ...
        'columns' => [
            ...
            [
             ...
             'value' => function($model) {
             		...
             		'filter' => Select2::widget([
             				...
             				'data' => ArrayHelper::map(VDbDatabaseSearchinterface::find()->select(['fk_client_id', 'client_name'])->distinct()->asArray()->all(), 'fk_client_id', 'client_name'),
            ...
            'filter' => Select2::widget([
            		...
            		'data' => ArrayHelper::map(VDbDatabaseSearchinterface::find()->select(['fk_project_id', 'project_name'])->distinct()->asArray()->all(), 'fk_project_id', 'project_name'),

...
<div class="objectcomment-view">
    ...
    <p>
        <?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('create-objectcomment')  ? Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) : "" ?>
		
        <?= Yii::$app->user->identity->isAdmin || Yii::$app->User->can('delete-objectcomment')  ? Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id], [

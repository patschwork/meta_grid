    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
             ...
             'value' =>         	    $model->fk_contact_group_id_as_supporter == "" ? $model->fk_contact_group_id_as_supporter : ($model->fkContactGroupIdAsSupporter === NULL ? Yii::t('app', "Can't lookup the {relFieldname} name (for id {this_id})", ['relFieldname' => 'fkContactGroupIdAsSupporter', 'this_id' => $model->fk_contact_group_id_as_supporter]) : $model->fkContactGroupIdAsSupporter->name)
            ],
        ],
    ]) ?>

...
?>
<div class="data-transfer-process-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
             ...
             'value' =>         	    $model->fk_data_transfer_type_id == "" ? $model->fk_data_transfer_type_id : ($model->fkDataTransferType === NULL ? Yii::t('app', "Can't lookup the {relFieldname} name (for id {this_id})", ['relFieldname' => 'fkDataTransferType', 'this_id' => $model->fk_data_transfer_type_id]) : $model->fkDataTransferType->name)
            ],
            'location:ntext',
